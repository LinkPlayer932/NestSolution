  ...
  return (
    <div className="w-full pt-24 py-10 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div
          className="w-screen relative left-1/2 right-1/2 ml-[-50vw] mr-[-50vw] text-center mb-10 bg-gradient-to-r from-red-700 to-gray-700 p-6  md:p-10 rounded-none"
        >
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="w-full p-4 md:p-10 rounded-2xl">
            <div className="flex items-center gap-2 text-sm">
              ...
              <div className="px-1.5 py-1 border border-gray-400 text-gray-400 text-[12px] rounded-sm">
                »
              </div>
              <span className="text-gray-800 font-medium">Contact Us</span>
            </div>
          ...
          <div className="w-full bg-white shadow-xl shadow-gray-300 p-4 md:p-10 rounded-2xl">
            ...
            <form className="w-full space-y-4">
              ...
              <p>In a hurry? Give us a call now at  <span className="font-semibold">03435743690</span></p>
            </form>
          </div>
        </div>
      </div>
